    ...
    return (
        <div className='flex flex-col w-full'>
            ...
            <div className='flex flex-row justify-between items-end'>
                <h3 className='text-green-foreground brightness-125 text-xl turret-road-bold text-left md:px-4 md:text-5xl'>Mobile App Engineer</h3>
            ...
            <div className='flex flex-col justify-start items-end w-full pt-2 gap-y-1 md:flex-row md:pt-8 md:gap-x-32'>
                ...
                <div className='flex flex-row justify-between items-end w-full md:w-fit'>
                    ...
                    <p className='px-0 text-green-foreground brightness-125 text-sm turret-road-regular text-left md:text-xl md:px-4'>Jun 2021 - Aug 2023</p>
                </div>
            </div>
            ...
            <div className='flex flex-col pt-8 pl-0 pb-4 md:pb-8 md:pl-4 md:pt-16'>
                ...
                <ul className='list-disc pl-4 grid columns-1 gap-y-2 mb-0 pt-2 md:pt-4 md:mb-8 md:gap-y-8 md:pl-16'>
                    ...
                    <li className='text-green-foreground brightness-125 text-sm turret-road-regular text-left md:text-xl grid columns-1 gap-y-2'>
