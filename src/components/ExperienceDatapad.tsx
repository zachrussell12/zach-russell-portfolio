...
export default function ExperienceDatapad() {
    ...
    return (
        <div className='bg-foreground flex flex-col w-full relative z-50 p-2 py-4 rounded-xl datapad-hard-shadow md:p-4 md:py-6 md:h-full md:w-4xl'>
            ...
            <div id="screen" className='bg-background border-[1px] border-white/25 px-2 py-2 rounded-xl relative flex flex-col justify-center items-center overflow-hidden md:px-4 md:py-2'>
                ...
                <div id='datapad-content' className='w-full h-full flex flex-col datapad-glow-effect'>
                    ...
                    <h2 className='text-green-foreground brightness-125 text-xl p-0 turret-road-extrabold text-center md:text-5xl md:p-2 lg:text-5xl lg:p-2'>EXPERIENCE DATABASE</h2>
                    <img className='brightness-125 w-full py-1' src={ThinLine} />

                    <div className='flex-row justify-between hidden items-center px-0 md:px-4 lg:px-4 md:flex'>
                        <div className='flex flex-col w-full h-full'>
                            <div className='flex flex-col min-w-3/4 max-h-32 flex-wrap '>
                                <p className='text-green-foreground brightness-125 turret-road-bold py-0 text-lg md:py-4 md:text-2xl lg:py-4 lg:text-2xl'><span className='turret-road-extrabold pr-4'>NAME:</span> Zachary Russell</p>
                                <p className='text-green-foreground brightness-125 turret-road-bold py-0 text-lg md:py-4 md:text-2xl lg:py-4 lg:text-2xl'><span className='turret-road-extrabold pr-4'>ORIGIN:</span> Tampa, FL</p>
                                <p className='text-green-foreground brightness-125 turret-road-bold py-0 text-lg md:py-4 md:text-2xl lg:py-4 lg:text-2xl'><span className='turret-road-extrabold pr-4'>PRONOUNS:</span> He/Him</p>
                                <p className='text-green-foreground brightness-125 turret-road-bold py-0 text-lg md:py-4 md:text-2xl lg:py-4 lg:text-2xl'><span className='turret-road-extrabold pr-4'>LOCATION:</span> Orlando, FL</p>
                            </div>
                    ...
                    <img className='brightness-125 w-full py-1 hidden md:inline' src={ThinLine} />

                    
                    <div id='experience-container' className='pt-2 w-full h-full flex flex-row md:pt-8'>
            ...
            <div id='button-container' className='w-full flex flex-row justify-between items-center pt-2 md:pt-4 lg:pt-4'>
                <div className='flex flex-row gap-x-4'>
                    <div className='bg-orange-background p-2 rounded-full border-1 border-orange-foreground/50 button-shadow-orange md:p-4 lg:p-4'>
                        <img className='aspect-square object-contain h-6 md:h-6 lg:h-6 self-center' src={ButtonSymbolOne} />
                    </div>
                    <div className='bg-pink-background p-2 rounded-full border-1 border-pink-foreground/50 button-shadow-pink md:p-4 lg:p-4'>
                        <img className='aspect-square object-contain h-6 md:h-6 lg:h-6 self-center' src={ButtonSymbolTwo} />
                    </div>
                </div>
                <div className='flex flex-row justify-end items-center w-1/2 gap-x-3 md:gap-x-4'>
                    <button onClick={() => {window.open(experienceLinks[position])}} className='bg-purple-background py-2 px-1 rounded-full border-1 border-purple-foreground/50 button-shadow-purple purple-rounded cursor-pointer md:p-4 lg:p-4'>
                        <MdOpenInNew size={30} className='text-purple-foreground h-6' />
                    </button>
                    <div className='flex flex-row gap-x-2 md:gap-x-4'>
                        <button onClick={previousExperience} className='bg-green-background py-2 px-2 rounded-lg border-1 border-green-foreground/50 button-shadow-green green cursor-pointer arrow-button md:py-2 md:px-8'>
                            <img className='w-8 h-8 md:w-14 md:h-14' src={ArrowIcon} />
                        </button>
                        <button onClick={nextExperience} className='bg-green-background py-2 px-2 rounded-lg border-1 border-green-foreground/50 button-shadow-green green cursor-pointer arrow-button md:py-2 md:px-8'>
                            <img className='w-8 h-8 md:w-14 md:h-14 rotate-180' src={ArrowIcon} />
                        </button>
                    </div>
                </div>
            </div>
